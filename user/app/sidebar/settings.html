      ...
      <div class="slim-mainpanel">
        <div class="container">
          <div class="slim-pageheader">
            ...
            <h6 class="slim-pagetitle">Einstellungen</h6>
          </div><!-- slim-pageheader -->
                ...
                <div class="card-body">
                  <div class="media">
                    <div class="media-body">
                      <h3 class="card-profile-name">Torben Hammes</h3>
                      <p>Berlin, Deutschland</p>
                    </div><!-- media-body -->
                  </div><!-- media -->
                  <div class="row">
                    <div class="col-lg-12 align-left">
                      <p><b>Adresse: </b>Königstraße 3a</p>
                      <p><b>Postleitzahl: </b> 13599</p>
                      <p><b>Ort: </b>Berlin</p>
                      <p><b>Email: </b> hammes@th-brandenburg.de</p>
                    </div>
                  </div>
                </div><!-- card-body -->
                <div class="card-footer">
                  <div>
                    <a href="">Profil & Einstellungen bearbeiten</a>
                  </div>
                </div><!-- card-footer -->
              </div><!-- card -->
            </div><!-- col-12 -->
