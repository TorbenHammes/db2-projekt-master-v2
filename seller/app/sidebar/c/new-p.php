...
<head>
    ...
    <title>Neues Produkt anlegen | Regio Karte</title>
        ...
        <div class="container">
            <div class="slim-pageheader">
                <ol class="breadcrumb slim-breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Produkt anlegen</li>
                </ol>
                <h6 class="slim-pagetitle">Neues Produk</h6>
            </div><!-- slim-pageheader -->
        </div>
        <div>
            <div class="section-wrapper">
                <label class="section-title">Produkt anlegen</label>
                ...
                <div class="row">
                    <div class="col">
                        <form method=GET>
                            ...
                            <input name=preis><br>
                            Kategorie:<br>
                            <select id="cars" name="kategorie">
                                <option value="1">Gemüse</option>
                                <option value="2">Obst</option>
                                <option value="3">Kräuter</option>
                                <option value="4">Eier</option>
                                <option value="5">Sonstiges</option>
                            </select><br>
                            Bildlink:<br>
                            <input name=bild><br>
                            Beschreibung:<br>
                            <input type="textarea" name="beschr"><br>
                            <input type=submit>
                        </form>
                    </div>
                </div>
